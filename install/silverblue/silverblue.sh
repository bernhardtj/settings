...
# brew bundle --file <( curl -fSsL https://raw.githubusercontent.com/projectbluefin/common/refs/heads/main/system_files/shared/usr/share/ublue-os/homebrew/ai-tools.Brewfile )
